...
function displayMenus(menus) {
    ...
    menus.forEach(menu => {
        ...
        let imageHtml = '';
        if (menu.picture) {
            const imageUrl = `https://restaurantquaiantique-production.up.railway.app${window.escapeHtml(menu.picture.url)}`;
...
function displayFoodsByCategory(foods) {
    ...
    Object.keys(foodsByCategory).sort().forEach(categoryName => {
        ...
        foodsByCategory[categoryName].forEach(food => {
            ...
            let imageHtml = '';
            if (food.picture) {
                const imageUrl = `https://restaurantquaiantique-production.up.railway.app${window.escapeHtml(food.picture.url)}`;
