...
async function createUser() {
    ...
    try {
        const response = await fetchWithAuth("https://ton-backend.up.railway.app/api/admin/create-user", {
            method: "POST",
            headers: {
...
async function loadUsers() {
    const token = getToken();
    try {
        const response = await fetch("https://ton-backend.up.railway.app/api/admin/users", {
            headers: {
                "X-AUTH-TOKEN": token
            }
        });
...
async function updateUser() {
    ...
    try {
        const response = await fetch(`https://ton-backend.up.railway.app/api/admin/users/${email}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
                "X-AUTH-TOKEN": token
