...
async function updateInfos() {
  ...
  try {
    const res = await fetchWithAuth("https://restaurantquaiantique-production.up.railway.app/api/account", {
      method: "PUT",
      body: JSON.stringify({
...
async function deleteAccount() {
  ...
  try {
    const res = await fetchWithAuth("https://restaurantquaiantique-production.up.railway.app/api/account", { method: "DELETE" });
    if (!res.ok) throw new Error(await res.text());
